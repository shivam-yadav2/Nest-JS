  ...
  imports: [
    ConfigModule.forRoot({
      ...
      validationSchema: Joi.object({
        ...
        VIDEO_CHUNKS_PATH: Joi.string().default('./uploads/chunks'),
        VIDEO_THUMBNAILS_PATH: Joi.string().default('./uploads/thumbnails'),
        VIDEO_CHUNK_SIZE: Joi.number().default(20971520),
